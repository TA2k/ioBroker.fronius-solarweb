...
systemDictionary = {
    "fronius-solarweb adapter settings": {
        en: "Adapter settings for fronius-solarweb",
        de: "Adaptereinstellungen für fronius-solarweb",
        ru: "Настройки адаптера для fronius-solarweb",
        pt: "Configurações do adaptador para fronius-solarweb",
        nl: "Adapterinstellingen voor fronius-solarweb",
        fr: "Paramètres d'adaptateur pour fronius-solarweb",
        it: "Impostazioni dell'adattatore per fronius-solarweb",
        es: "Ajustes del adaptador para fronius-solarweb",
        pl: "Ustawienia adaptera dla fronius-solarweb",
        "zh-cn": "fronius-solarweb的适配器设置",
    },
    "App Email": {
        en: "App Email",
        de: "App-E-Mail",
